    ...
    <div className="flex flex-col items-center gap-2">
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <span className="text-[10px] text-white/40 uppercase tracking-wide">/ 100</span>
        </div>
      </div>
...
function SignalChip({
  ...
  return (
    ...
    >
      <div
        className={clsx('w-7 h-7 rounded-lg flex items-center justify-center shrink-0')}
        style={{
          background:
            good === true ? 'rgba(16,185,129,0.15)'
      ...
      >
        <Icon
          size={13}
          className={good === true ? 'text-emerald-400' : good === false ? 'text-rose-400' : 'text-white/40'}
        />
      </div>
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex items-center justify-between">
        ...
        {fitness && (
          <div
            ...
            style={glassCard}
          >
            <span>{fitness.season === 'SKI' ? '⛷️' : '🚴'}</span>
      ...
      {readiness && (
        <div className="rounded-2xl p-5" style={glassCard}>
          <p className="text-xs font-semibold text-white/40 uppercase tracking-wider mb-4">Today's Readiness</p>
          <div className="flex gap-6 items-start">
            <ReadinessRing score={readiness.score} zone={readiness.zone} />
            <div className="flex-1 flex flex-col gap-3">
              <p className="text-sm text-white/70 leading-relaxed">{readiness.guidance}</p>
      ...
      <div className="rounded-2xl p-5" style={glassCard}>
        <p className="text-xs font-semibold text-white/40 uppercase tracking-wider mb-4">Training Load</p>
      ...
      {fitness && fitness.series.length > 0 && (
        <div className="rounded-2xl p-5" style={glassCard}>
          <h2 className="text-sm font-semibold text-white/70 mb-5">90-Day Training Load</h2>
      ...
      <div>
        ...
        {plan ? (
          ...
          <div className="rounded-2xl p-8 text-center" style={glassCard}>
            <p className="text-white/40 text-sm mb-3">No plan for this week yet.</p>
            <a
              href="/plan"
        ...
        {plan?.narrative && (
          ...
          >
            ...
            <p className="text-sm text-white/70 leading-relaxed">{plan.narrative}</p>
          </div>
        )}
      </div>
      ...
      {/* Recent activity */}
      <div className="rounded-2xl p-5" style={glassCard}>
        <h2 className="text-sm font-semibold text-white/70 mb-4">Recent Activities</h2>
